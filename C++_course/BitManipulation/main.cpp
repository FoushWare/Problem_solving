/*#include<bits/stdc++.h> it include all the statndard headeras and STL header
but this will make compiliation take more time  i typed it here cause i saw it in the internet :)
but i will not use it right now :)
*/
#include <iostream>
#include<bitset>
...
why i'm using bitset?
 ...
 ==>Sometimes, it drop memory by factor of 8! so better memory order
   ...
   ** However, a limitation of bitset is, N must be known
